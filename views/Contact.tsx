    ...
    <section className="min-h-screen pt-28 pb-20 px-4 flex items-center justify-center">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8 flex flex-col justify-center">
          <div>
            <h2 className="font-cinzel text-4xl text-gold mb-4">Dispatch a Raven</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 text-neutral-300">
              <div className="w-10 h-10 bg-gold/10 border border-gold/30 flex items-center justify-center rotate-45">
                <Mail size={18} className="-rotate-45 text-gold" />
              </div>
              <span className="font-mono text-sm">raven@chronicles.dev</span>
            </div>
            <div className="flex items-center gap-4 text-neutral-300">
              <div className="w-10 h-10 bg-gold/10 border border-gold/30 flex items-center justify-center rotate-45">
